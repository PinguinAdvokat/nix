            ...
            Row {
                ...
                Row {
                    ...
                    Rectangle {
                        ...
                        radius: 12
                        anchors.verticalCenter: parent.verticalCenter
                        color: activePlayer && activePlayer.playbackState === 1 ? Dat.Colors.colActive : Dat.Colors.colModuleBgHover
                        visible: root.playerAvailable
                        opacity: activePlayer ? 1 : 0.3
                        ...
                        DankIcon {
                            ...
                            name: activePlayer && activePlayer.playbackState === 1 ? "pause" : "play_arrow"
                            size: 14
                            color: activePlayer && activePlayer.playbackState === 1 ? Dat.Colors.colModuleBg : Dat.Colors.colActive
                        }
