...
PanelWindow {
    ...
    readonly property color cSurface: Dat.Colors.colBG
    readonly property color cSurfaceContainer: Qt.lighter(Dat.Colors.colBG, 1.15)
    readonly property color cPrimary: Dat.Colors.colActive
    readonly property color cText: Dat.Colors.colText
