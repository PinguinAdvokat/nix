...
PanelWindow {
    ...
    Rectangle {
        ...
        border.color: Dat.Colors.colModuleBg
        border.width: 1
        radius: 9
        clip: true
        ...
        ColumnLayout {
            ...
            Rectangle {
                ...
                color: backMouse.containsMouse ? Dat.Colors.colModuleBg : "transparent"
                ...
                RowLayout {
                    ...
                    Text {
                        text: "⬅ Back"
                        color: Dat.Colors.colActive
                        font.family: Dat.Fonts.fontFamily
                        font.bold: true
                        font.pixelSize: Dat.Fonts.fontSize - 3
                    }
                }
                MouseArea {
                    id: backMouse
            ...
            Repeater {
                ...
                delegate: Rectangle {
                    ...
                    color: itemMouse.containsMouse && !isSeparator ? Dat.Colors.colOutline : Dat.Colors.colModuleBg
                    radius: 9
                    ...
                    RowLayout {
                        ...
                        Rectangle {
                            ...
                            color: "transparent"
                            border.color: Dat.Colors.colText
                        ...
                        Text {
                            ...
                            color: Dat.Colors.colText
                            font.family: Dat.Fonts.fontFamily
                            font.pixelSize: Dat.Fonts.fontSize - 4
                            Layout.fillWidth: true
